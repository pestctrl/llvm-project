...
; SAMPLE-CODE:         br i1 [[TMP1]], label %[[TMP2:.*]], label %[[TMP4:.*]], !prof ![[BRW:[0-9]+]]
; SAMPLE-CODE:       [[TMP2]]:
...
; SAMPLE-WEIGHT: ![[BRW]] = !{!"branch_weights", i32 200, i32 65336}
; SAMPLE-WEIGHT100: ![[BRW]] = !{!"branch_weights", i32 100, i32 65436}
; UNSAMPLED-WEIGHT: ![[BRW]] = !{!"branch_weights", i32 65536, i32 0}
